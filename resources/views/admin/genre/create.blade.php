...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <form class="m-form" id="user" method="POST"
              action="{{ route('genre.create') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="m-portlet__body">
                ...
                <div class="m-form__section m-form__section--first">
                    @foreach((new Genre())->getAttributesList($attributes) as $attribute => $value)
                        <div class="form-group m-form__group row">
                            <label class="col-lg-3 col-form-label">
                                {{ $attribute }}:
                            </label>
                            <div class="col-lg-6">
                                {!! (new Genre())->getHtmlCreateForAttribute($attribute) !!}
