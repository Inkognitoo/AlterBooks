...
$attributes = [
    ...
    'avatar', 'name', 'surname',
    'patronymic', 'gender', 'birthday_date',
    'about', 'timezone', 'is_admin'
];
@endphp
        ...
        <form class="m-form" id="user" method="POST"
            ...
            <div class="m-portlet__body">
                ...
                <div class="m-form__section m-form__section--first">
                    @foreach((new User())->getAttributesList($attributes) as $attribute => $value)
                        <div class="form-group m-form__group row">
                            <label class="col-lg-3 col-form-label">
                                {{ $attribute }}:
                            </label>
                            <div class="col-lg-6">
                                {!! (new User())->getHtmlCreateForAttribute($attribute) !!}
