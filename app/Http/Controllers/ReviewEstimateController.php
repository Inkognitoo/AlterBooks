...
class ReviewEstimateController extends Controller
{
    ...
    public function plus($book_id, $id)
    {
        ...
        if ($review_estimate->estimate > 0) {
            ...
            $this->out['code'] = 400;
            $this->out['data']['message'] = __('review_estimate.positive_already_exist');
        ...
        $this->out['code'] = 200;
        $this->out['data']['message'] = __('review_estimate.success_add');
    ...
    public function minus($book_id, $id)
    {
        ...
        if ($review_estimate->estimate < 0) {
            $this->out['success'] = false;
            $this->out['code'] = 400;
            $this->out['data']['message'] = __('review_estimate.negative_already_exist');
